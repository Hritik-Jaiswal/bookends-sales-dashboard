...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f0e8] flex flex-col">
      ...
      <main className="flex-1 px-6 pb-8 max-w-[1800px] mx-auto w-full">
        {/* KPI Cards */}
        <div className="mt-5">
        ...
        {/* Tab bar */}
        <div className="mt-5 flex items-center gap-2 border-b border-[#e0d9cc]">
          {TABS.map(tab => (
            <button
              key={tab.key}
              onClick={() => setActiveTab(tab.key)}
              className={`px-6 py-2.5 text-sm font-semibold rounded-t-xl transition-all -mb-px ${
                activeTab === tab.key
        ...
        {/* Error banner */}
        {error && (
          <div className="mt-4 bg-red-50 border border-red-200 text-red-700 rounded-2xl px-6 py-4 flex items-center gap-3">
